...
⚠️ THESE ARE ESTIMATES, not measured positioning. AUM and target-vol conventions
...
#:   max_20_60 -> max(20d, 60d) realized (de-risk fast, re-risk slow: the common
#:               vol-control convention).
#:   ewm_94    -> RiskMetrics EWMA (lambda 0.94).
#:   rv_63     -> a slower ~quarter window (risk-parity-like).
Estimator = Literal["max_20_60", "ewm_94", "rv_63"]
...
_ROWS: tuple[FundCohort, ...] = (
    FundCohort("vol_control", "vol_control", 350e9, 0.10, 1.5, "max_20_60"),
